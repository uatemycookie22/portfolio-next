...
const Technology = ({src, alt}: TechnologyProps) => (<>
	<div className="flex flex-col relative group items-center">
		...
		<span
			className={`scale-0 w-auto absolute top-10 min-w-max
			bg-zinc-500 text-white rounded-lg p-1 group-hover:scale-100 transition-all duration-50 z-50 hover:hidden`}>
			{alt}
		</span>
